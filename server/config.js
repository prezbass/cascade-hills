const required = ['DB_HOST','DB_PORT','DB_NAME','DB_USER','DB_PASSWORD','SMTP_HOST','SMTP_PORT','SMTP_USERNAME','SMTP_PASSWORD','FROM_EMAIL_ADDRESS','FROM_EMAIL_NAME','CONTACT_TO_EMAIL']
